import{_ as n,o as s,c as a,a as e}from"./app-568110d5.js";const l={},i=e(`<h1 id="class-typed-properties" tabindex="-1"><a class="header-anchor" href="#class-typed-properties" aria-hidden="true">#</a> Class Typed Properties</h1><p>It is recommended to use type hints for properties whenever possible instead of relying solely on docblocks.</p><h2 id="ok" tabindex="-1"><a class="header-anchor" href="#ok" aria-hidden="true">#</a> OK</h2><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token keyword">class</span> <span class="token class-name-definition class-name">PunchRecordRepository</span>
